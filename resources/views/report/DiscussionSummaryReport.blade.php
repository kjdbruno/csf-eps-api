...
<html lang="en">
<head>
    <title>Discussion Summary Report</title>
    <meta charset="utf-8">
...
<body>
    <div style="padding: 25px 25px 0px 25px;">
        <div style="text-align: center;">
            ...
            <div class="h4">Discussion Summary Report</div>
        ...
        <div style="padding: 25px 0px 0px 0px;">
            <table>
                ...
                <tr>
                    <td><div style="text-transform: uppercase;">total</div></td>
                    <td style="text-align: center;">{{ $totalDiscussion }}</td>
                </tr>
                <tr>
                    <td><div style="text-transform: uppercase;">active</div></td>
                    <td style="text-align: center;">{{ $totalActive }}</td>
                </tr>
                <tr>
                    <td><div style="text-transform: uppercase;">inactive</div></td>
                    <td style="text-align: center;">{{ $totalInactive }}</td>
                </tr>
            </table>
        </div>
        <div style="padding: 25px 0px 0px 0px;">
            <table>
                <tr>
                    <th style="width: 70%;"><div style="text-transform: uppercase;">Per Category</div></th>
                    <th><div style="text-transform: uppercase; text-align: center;">count</div></th>
                </tr>
                @foreach($data as $dt)
                <tr>
