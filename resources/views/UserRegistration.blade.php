...
<html>
<head>
    <title>ePS. Verification Code</title>
</head>
<body>
            ...
            <tr>
                <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 10px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <p style="margin: 0;">Before you continue, we need to verify your account first. Please copy the code below.</p>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="center" style="border-radius: 3px; font-size: 3em; font-weight: bold; letter-spacing: 2mm;" bgcolor="#fff">{{$code}}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
