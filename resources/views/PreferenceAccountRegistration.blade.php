            ...
            <tr>
                <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 10px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <p style="margin: 0;">This is to confirm that you are already registered to eParticipation System. The Community Engagement Platform of the City of San Fernando, La Union. Please wait as we verify your account. We'll send a separate e-mail after we verify your account.</p>
                            </td>
                        </tr>
                        <tr>
